...
public class ForeignExchange {
    ...
    public ForeignExchange() {
        ...
        this.userHistory = new UserHistory(); // Initialize user history
    }
    ...
    public double convertCurrency(String from, String to, double amount) {
        try {
            ...
            userHistory.recordFavoriteCurrency(from); // Record the favorite currency
    ...
    public void viewCurrency(String baseCurrency) {
        try {
            ...
            userHistory.recordFavoriteCurrency(baseCurrency); // Record the favorite currency
    ...
    // Method to print the top frequently used currencies
    public void printTopFrequentlyUsedCurrencies(int top) {
        userHistory.printTopFavoriteCurrencies(top); // Print the top favorite currencies
    }
    ...
    public static void main(String[] args) {
        ...
        foreignExchange.printTopFrequentlyUsedCurrencies(2); // Print top 2 frequently used currencies
    }
}
